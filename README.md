...
```shell
python pdbe_complexes/main.py -b <bolt_url> -u <username> -p <password> -o <output_csv_path> -i <complex_portal_path> -c <pdbe_complex_path>`
```
...
- `pdbe_complex_path` = The path to the PDBe-KB complexes FTP site
