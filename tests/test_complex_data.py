...
class TestComplexData(TestCase):
    ...
    @patch("complexes.utils.get_data_from_graph_db.GetComplexData.run_query")
    def test_uniprot_molecule_names(self, rq):
        ...
        complex_obj.populate_molecule_names_from_uniprot_or_rfam("uniprot")
    ...
    def test_rfam_molecule_names(self, rq):
        ...
        complex_obj.populate_molecule_names_from_uniprot_or_rfam("rfam")
    ...
    def test_entity_molecule_names(self, rq):
        ...
        complex_obj.populate_molecule_names_from_entity()
    ...
    def test_get_pdb_complex_data(self, rq):
        ...
        # print(complex_obj.pdb_complexes)
